 ...
 */
@WebServlet(name = "ShowEmpInfoServlet", urlPatterns = {"/ShowEmpInfoServlet"})
public class ShowEmpInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            showEmpInfoDTO dto = dao.getEmpInfoInRequestLeave(empID);
            ...
            response.sendRedirect(requestLeavePage);
            out.close();
        }
    }
